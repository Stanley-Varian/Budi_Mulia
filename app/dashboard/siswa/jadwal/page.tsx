...
function s(m: string, g: string): Slot {
  return { mapel: m, guru: g };
}
      ...
      <div className={`${styles.main} ${expanded ? styles.mainShifted : ""}`}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.modeSwitcher}>
            <button
              className={`${styles.modeBtn} ${mode === "jadwal" ? styles.modeBtnActive : ""}`}
            ...
            <button
              className={`${styles.modeBtn} ${mode === "ekskul" ? styles.modeBtnActive : ""}`}
              onClick={() => setMode("ekskul")}
            >
              <svg
                width="14"
                height="14"
                  ...
                  <thead>
                    <tr>
                      ...
                      {HARI.map((h) => (
                        <th
                          key={h}
                          className={`${styles.thHari} ${h === hariIni ? styles.thHariToday : ""} ${h === activeHari ? styles.thHariActive : ""}`}
                        >
                          {h}
                          {h === hariIni && (
                    ...
                    {JAM_NO.map((label, ri) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className={styles.tdWaktu}>
                            {isIst ? "Istirahat" : JAM_WAKTU[ri]}
                          </td>
                          {HARI.map((h) => {
                            if (isIst)
                              return (
                                <td key={h} className={styles.tdIstirahat}>
                                  Istirahat
                                </td>
                              );
                            ...
                            if (!cell || cell === "istirahat")
                              return (
                                <td key={h} className={styles.tdEmpty}>
                                  —
                                </td>
                              );
                ...
                return (
                  <div key={hari} className={styles.ekskulGroup}>
                    <div className={styles.ekskulHari}>
                      {hari}
                      {hari === hariIni && (
                        <span className={styles.todayBadge2}>Hari ini</span>
                      )}
                    </div>
                    {list.map((e, i) => (
                      <div
