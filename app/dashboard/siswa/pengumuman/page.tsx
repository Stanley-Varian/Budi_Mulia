...
const MOCK_DATA: Pengumuman[] = [
  { id:1, judul:"Libur Nasional Hari Buruh", isi:"Diberitahukan kepada seluruh siswa bahwa pada tanggal 1 Mei 2025 sekolah diliburkan dalam rangka peringatan Hari Buruh Nasional. Kegiatan belajar mengajar kembali normal pada tanggal 2 Mei 2025.", penulis:"Tata Usaha", tanggal:"Hari ini", tag:"Umum", tagColor:"#dbeafe", tagText:"#1e40af", penting:true },
  { id:2, judul:"Ulangan Harian Matematika Kelas 10", isi:"Ulangan harian Matematika untuk kelas 10 A dan 10 B akan dilaksanakan pada hari Rabu, 7 Mei 2025 pada jam pelajaran ke-1 dan ke-2. Materi yang diujikan adalah Bab 3: Sistem Persamaan Linear.", penulis:"Bpk. Andi Saputra", tanggal:"Hari ini", tag:"Matematika", tagColor:"#dbeafe", tagText:"#1e40af", penting:false },
  { id:3, judul:"Pengumpulan Tugas Bahasa Indonesia", isi:"Tugas makalah Bahasa Indonesia dikumpulkan paling lambat Jumat, 9 Mei 2025. Pengumpulan dilakukan melalui sistem ini di menu Materi > Bahasa Indonesia > Tugas.", penulis:"Ibu Sari Dewi", tanggal:"Kemarin", tag:"B. Indo", tagColor:"#fce7f3", tagText:"#9d174d", penting:false },
  { id:4, judul:"Jadwal Remedial Ujian Tengah Semester", isi:"Siswa yang belum mencapai KKM pada Ujian Tengah Semester wajib mengikuti remedial yang dijadwalkan pada tanggal 12–14 Mei 2025. Daftar nama siswa dan jadwal lengkap dapat dilihat di papan pengumuman sekolah.", penulis:"Wakil Kurikulum", tanggal:"2 hari lalu", tag:"Akademik", tagColor:"#f0fdf4", tagText:"#14532d", penting:true },
  { id:5, judul:"Praktikum Kimia Minggu Depan", isi:"Praktikum Kimia untuk kelas 10 B akan dilaksanakan pada hari Kamis, 15 Mei 2025 di Lab IPA. Siswa diwajibkan memakai jas lab dan membawa alat tulis.", penulis:"Ibu Wulandari", tanggal:"3 hari lalu", tag:"Kimia", tagColor:"#ede9fe", tagText:"#6d28d9", penting:false },
];
...
const NAV = [
  ...
  { label:"Pengumuman",  href:"/dashboard/siswa/pengumuman", active:true,  icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg> },
              ...
              >
                ...
                <div className={styles.cardMeta}>
                  <div className={styles.cardMetaLeft}>
                    <span className={styles.tagChip} style={{ background: item.tagColor, color: item.tagText }}>
                      {item.tag}
                    </span>
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <div className={styles.modalTags}>
                <span className={styles.tagChip} style={{ background: selected.tagColor, color: selected.tagText }}>
                  {selected.tag}
                </span>
                {selected.penting && (
                  <span className={styles.pentingBadge}>
