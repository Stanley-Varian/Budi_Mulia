              ...
              <div className={styles.toggleList}>
                <div className={styles.toggleRow}>
                  <div className={styles.toggleInfo}>
                    ...
                    <span className={styles.toggleDesc}>Notifikasi saat ada pengumuman dari guru atau admin</span>
                  </div>
                ...
                <div className={styles.toggleRow}>
                  <div className={styles.toggleInfo}>
                    ...
                    <span className={styles.toggleDesc}>Notifikasi saat guru mengupload materi baru</span>
                  </div>
                ...
                <div className={styles.toggleRow}>
                  <div className={styles.toggleInfo}>
                    ...
                    <span className={styles.toggleDesc}>Notifikasi saat ada perubahan jadwal pelajaran</span>
                  </div>
