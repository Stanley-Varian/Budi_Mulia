...
const NAV = [
  { labelKey: "nav.dashboard" as const, href:"/dashboard/guru",            active:false, icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg> },
  { labelKey: "nav.jadwal" as const,    href:"/dashboard/guru/jadwal",     active:false, icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
  { labelKey: "nav.pengumuman" as const,href:"/dashboard/guru/pengumuman", active:false, icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg> },
  { labelKey: "nav.pengaturan" as const,href:"/dashboard/guru/settings",   active:true,  icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> },
];
    ...
    <div className={styles.layout}>
      ...
      <aside className={`${styles.sidebar} ${expanded ? styles.sidebarExpanded : ""}`}>
        ...
        <nav className={styles.nav}>
          {NAV.map((item, i) => (
            <a key={i} href={item.href} className={`${styles.navItem} ${item.active ? styles.navActive : ""}`} title={!expanded ? t(item.labelKey) : undefined}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.fieldGroup}>
                <div className={styles.field}>
                  <span className={styles.fieldLabel}>{t("settings.namaLengkap")}</span>
                ...
                <div className={styles.field}>
                  <span className={styles.fieldLabel}>{t("settings.username")}</span>
              ...
              <div className={styles.toggleList}>
                <div className={styles.toggleRow}>
                  <div className={styles.toggleInfo}>
                    <span className={styles.toggleLabel}>{t("settings.notifPengumuman")}</span>
                    <span className={styles.toggleDesc}>{t("settings.notifPengumumanDesc")}</span>
                  </div>
                  <Toggle value={notifPengumuman} onChange={setNotifPengumuman} />
                </div>
                <div className={styles.toggleRow}>
                  <div className={styles.toggleInfo}>
                    <span className={styles.toggleLabel}>{t("settings.notifJadwal")}</span>
                    <span className={styles.toggleDesc}>{t("settings.notifJadwalDesc")}</span>
                  </div>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.bahasaGroup}>
                {[
                  ...
                  <button
                    key={b.val}
                    className={`${styles.bahasaBtn} ${lang === b.val ? styles.bahasaBtnActive : ""}`}
                    onClick={() => changeLang(b.val as "id" | "en")}
                  >
      ...
      {showLogout && (
        <div className={styles.modalOverlay} onClick={() => setShowLogout(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <p className={styles.modalDesc}>{t("logout.desc")} Bpk. Andi Saputra.</p>
